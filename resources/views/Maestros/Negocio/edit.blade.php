        ...
        <section class="content container-fluid">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3>Editar Negocio<a href="/proveedor"><button class="btn btn-md btn-succes pull-right">Listado</button></a></h3>
                </div>
                <div class="box-body">
                    <div class="col col-md-6 col-md-offset-3">
                        {!!Form::model($negocio, ['route' => ['negocio.update', $negocio->id], 'method' => 'PATCH'])!!}
                        {{Form::token()}}
                        <div class="row">
                        ...
                        <div class="form-group">    
                            ...
                            <input type="text" readonly class="numeric form-control" value="{{ $neg->codred }}-{{ $neg->desred }}" >
                        </div>
                        <div class="form-group">    
                            <label for="idzon">Zona</label>
                            <input type="text" readonly class="numeric form-control" value="{{ $neg->codzon }}-{{ $neg->nomzon }}" > 
                        </div>
                        <div class="form-group">    
                            <label for="idloc">Localidad</label>
                            <input type="text" readonly class="numeric form-control" value="{{ $neg->codloc }}-{{ $neg->nomloc }}" > 
                        </div>
                        <div class="form-group">
                            <label for="nomneg">Nombre de negocio *</label>
                            <input type="text" name="nomneg" class="text form-control" value="{{ $neg->nomneg }}">
                        </div>
                        <div class="form-group">
                            <label for="direccion">Dirección</label>
                            <input type="text" name="direccion" class="text form-control" value="{{ $neg->direccion }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="telefono" name="telefono" class="numeric form-control" value="{{ $neg->telefono }}">
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" name="email" class="form-control" value="{{ $neg->email }}">
                        </div>
                        <div class="form-group">
